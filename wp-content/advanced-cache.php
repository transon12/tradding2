...
$possible_plugin_locations = array(
	...
	'/Applications/XAMPP/xamppfiles/htdocs/tradding/wp-content/plugins/wp-optimize/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('https://localhost/tradding/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/Applications/XAMPP/xamppfiles/htdocs/tradding/wp-content/plugins/wp-optimize/cache/extensions');
}
