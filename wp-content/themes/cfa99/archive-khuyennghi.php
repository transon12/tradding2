                                        ...
                                        <tbody>
                                            <?php while (have_posts()) : the_post();
                                                ...
                                                $dataValue = [
                                                    ...
                                                    [
                                                        'label' => 'Giá mua ',
                                                        "value" => get_field('gia_mua', get_the_ID()) ?number_format(get_field('gia_mua', get_the_ID()), 3): 'đang cập nhật',
                                                        "color" => get_field('gia_mua', get_the_ID()) ? '#FEC703': '#000'
                                                    ],
                                                    [
                                                        'label' => 'Giá chốt lời ', 
                                                        "value" => get_field('gia_loi', get_the_ID()) ? number_format(get_field('gia_loi', get_the_ID()),3) : 'đang cập nhật',
                                                        "color" => get_field('gia_loi', get_the_ID()) ? '#60B523' : '#000'
                                                    ],
                                                    [
                                                        'label' => 'Giá cắt lỗ',
                                                        "value" => get_field('gia_cat_lo', get_the_ID())? number_format(get_field('gia_cat_lo', get_the_ID()),1): 'đang cập nhật', 
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><span data-id="<?php echo get_the_ID(); ?>" class="open"><?php echo wp_trim_words(get_field('phan_tich_ly_do'), 20, '...') ?></span><a class="popup" href="#khuyennghi"></a></td>
