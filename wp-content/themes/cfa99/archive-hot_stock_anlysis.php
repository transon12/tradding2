                        ...
                        <?php if ( have_posts() ) : ?>
                            <div id="filter-table">
                                    <div class="filter-left">
                                        <div class="filter-care hotstock">
                                            <div class="save-car">
                            ...
                            <table id="uptrend_stocks" class="dataTable chung">
                                ...
                                ?>
                                    ...
                                    <td>
                                        <?php
                                            echo '<a href="'.get_the_permalink($id_stocks).'">';
