...
<div class="slicewp-grid slicewp-grid-affiliate-dashboard slicewp-grid-affiliate-dashboard-last-30-days">
    ...
    <div class="slicewp-card slicewp-card-affiliate-dashboard 123456">
        ...
        <div class="slicewp-card-inner">
            ...
            <div class="slicewp-kpi-value">
                ...
                <?php 
                    $percentage_change = slicewp_calculate_percentage_change( array_sum( $previous_commissions ), array_sum( $current_commissions ) ); 
                ?>
                
                <?php echo slicewp_format_amount_custom( array_sum( $current_commissions ), slicewp_get_setting( 'active_currency', 'USD' ) ); ?>
...
<div class="slicewp-grid slicewp-grid-affiliate-dashboard slicewp-grid-affiliate-dashboard-all-time">
    ...
    <div class="slicewp-card slicewp-card-affiliate-dashboard">
        ...
        <div class="slicewp-card-inner">
            ...
            <div class="slicewp-kpi-value"><?php echo slicewp_format_amount_custom( array_sum( $paid_commissions ), slicewp_get_setting( 'active_currency', 'USD' ) ); ?></div>
    ...
    <div class="slicewp-card slicewp-card-affiliate-dashboard">
        ...
        <div class="slicewp-card-inner">
            ...
            <div class="slicewp-kpi-value"><?php echo slicewp_format_amount_custom( array_sum( $unpaid_commissions ), slicewp_get_setting( 'active_currency', 'USD' ) ); ?></div>
