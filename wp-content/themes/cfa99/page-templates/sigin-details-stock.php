<?php
/*
	Template Name: Sigin chi tiết cổ phiếu

*/
get_header(); 
?>

<section class="section p-0 sigin-details-stock">
                                ...
                                <div class="col large-12 medium-12 small-12 stock-heading">
                                    <div class="col-inner">
                                        <div class="stocker-heading-text">
                                            ...
                                            <a href="#"><h2 class="stock-title">Tất cả báo cáo</h2></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <a href="#"> <svg
                                                ...
                                                <div class="comp-info-details">
                                                    <div class="info-detail-name">
                                                        <a href="#"><h1>CÔNG TY CỔ PHẦN VINHOMES</h1></a>
                                ...
                                <div class="col-inner">
                                        <div class="tabbed-content">
                                            <ul class="nav nav-line-bottom nav-normal nav-size-xlarge nav-left">
                                                <li class="tab has-icon tongquan">
