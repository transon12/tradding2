<?php
/*
	Template Name: Quản lý tài khoản 2
                                    ...
                                    <div class="px bg-fff">
                                        ...
                                        <table id="uptrend_stocks" class="dataTable">
                                            ...
                                            <tr>
                                                ...
                                                <img
                                                    src="https://cfa99.net/wp-content/themes/cfa99/assets/img/sort.svg"
                                                />
                                                <img
                                                    src="https://cfa99.net/wp-content/themes/cfa99/assets/img/up.svg"
                                                />
                                                </th>
                                            ...
                                            <tr>
                                                ...
                                                <span class="avata"
                                                    ...
                                                    width="90"
                                                    height="47"
                                                    src="https://cfa99.net/medias/2022/07/vinhomes_logo.svg"
                                                    class="attachment-full size-full wp-post-image"
                                                    alt="" /></span
                                                ><span class="code_stocks">VHM</span>
                                                </td>
                                                <td class="title_stocks">CÔNG TY CỔ PHẦN VINHOMES 2</td>
                                                <td>61402<span class="char_money">vnd</span></td>
                                                <td>61401<span class="char_money">vnd</span></td>
                                            </tr>
                                            <tr>
                                                <td class="stt">
                                                <i class="icon-star-o"></i>
                                                ...
                                                <td class="title_stocks">CÔNG TY CỔ PHẦN VINHOMES</td>
                                                <td>61402<span class="char_money">vnd</span></td>
                                                <td>61401<span class="char_money">vnd</span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <span class="avata"
                                                    ...
                                                    width="241"
                                                    height="150"
                                                    src="https://cfa99.net/medias/2022/07/logo-nvl.jpg"
                                                    class="attachment-full size-full wp-post-image"
                                                    alt=""
                                                    loading="lazy" /></span
                                                ><span class="code_stocks">VHM</span>
                                                </td>
                                                <td class="title_stocks">CÔNG TY CỔ PHẦN NOVALAND</td>
                                                <td>61402<span class="char_money">vnd</span></td>
                                                <td>61401<span class="char_money">vnd</span></td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="panel entry-content" id="tab5">
                                    <div class="tab_inner"> <!--#tab5-->
                                        <div class="row row-small tab-custom-profile">
                                            ...
                                            <div class="col medium-12 small-12 large-6">
                                                <div class="col-inner">
                                                <button type="submit" form="form_edit-profile" value="Submit" class="edit_profile_submit check_validation">Lưu thay đổi</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
