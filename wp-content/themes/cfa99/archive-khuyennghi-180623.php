                                    ...
                                    <tr>
                                        <td class="stt">
                                            <?php $number=0; if(is_user_logged_in()){ 
                                                ...
                                                ?>
                                            <i data-id="<?php echo $idppost; ?>"
                                                class="icon-star-o add_bookmark <?php echo $class; ?>"></i>
                                            <?php } ?>
                                            <?php echo $i++;?>
                                        </td>
                                        <td>
                                            <div class="d-flex flex-center-item">
                                                <?php
                                                    $id=get_field('co_phieu');
                                                        echo '<span class="avata">';
                                                        echo get_the_post_thumbnail($id,'full');
                                                        echo '</span>';
                                                        if(get_field('ma_co_phieu')){
                                                            echo '<span class="code_stocks">';
                                                                the_field('ma_co_phieu');
                                                            echo '</span>';
                                                        }else{
                                                            echo '<span class="code_stocks">';
                                                                echo '...';
                                        ...
                                        <td><span data-id="<?php echo get_the_ID(); ?>"
                                                class="open"><?php  echo wp_trim_words(get_field('phan_tich_ly_do'),20,'...') ?></span><a
                                                class="popup" href="#khuyennghi"></a></td>
                                        <td><?php $term_list = wp_get_post_terms( $idppost, 'nganh', array( 'fields' => 'ids' ) );  echo $term_list[0]; ?>
                                        </td>
                            ...
                            <div class="course-entry-content">
                                ...
                                <div class="login-to-learn">
                                    ...
                                    <div class="haveto-upgrade haveto__login">
                                        <div class="blur-bg"
                                            style="background-image: url('https://www.w3schools.com/howto/photographer.jpg')">
                                        </div>
                                        ...
                                        <div class="blur-bg-content">
                                            ...
                                            <?php if(($now>$time) && !in_array($permission,$id)){
                                                                    ?>
                                            <div><a href="<?php echo home_url(); ?>/quan-ly-tai-khoan/nang-cap-tai-khoan/"
                                                    class="btn__reg c-btn" title="Đăng ký">Xin vui lòng gia hạn</a><a
                                                    href="<?php echo home_url(); ?>" class="mainbg btn__login c-btn"
                                                    title="Đăng nhập">Trở lại trang chủ</a></div>

                                            <?php
                                                                }else{ ?>
                                            <div><a href="<?php echo home_url(); ?>/quan-ly-tai-khoan/nang-cap-tai-khoan/"
                                                    class="btn__reg c-btn" title="Đăng ký">Nâng cấp ngay</a><a
                                                    href="<?php echo home_url(); ?>" class="mainbg btn__login c-btn"
                                                    title="Đăng nhập">Trở lại trang chủ</a></div>
