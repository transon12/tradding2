...
$checkview=$can_view_content_item->flag;
										...
										<div class="col-inner">
                                            ...
                                            <header class="entry-header">
                                                <h1 class="entry-title">
                                                    <?php echo get_the_title($id_lession);?>
                                                </h1>
                                            </header>
...
<?php if($checkview){ 
$history=get_user_meta($id_user,'historyvideo',true);
if(empty($history))
{
    $history=array();
}
if(!in_array($id_lession,$history)){
$history[]=$id_lession;   
update_user_meta( $id_user, 'historyvideo',$history); 
}
    
?>
                                                    <div class="course-content-media"> <!-- Video or media of course -->
                                                        <div class="course-content-video">
                                                            <iframe width="100%" height="350" src="<?php echo get_field('link_video',$id_lession); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="course-entry-readmore">
                                                        <?php echo get_post_field('post_content', $id_lession); ?>
                                                    </div>
...
<?php }else{ 
    $thumbnail=get_the_post_thumbnail_url($id_lession);
    if(empty($thumbnail))
    {
        $thumbnail="https://www.w3schools.com/howto/photographer.jpg";
    }
    ...
    <div class="login-to-learn">
                                                        ...
                                                        <div class="haveto-upgrade haveto__login">
                                                            <div class="blur-bg" style="background-image: url('<?php echo $thumbnail; ?>')"></div>
                                                            ...
                                                            <div class="blur-bg-content">
                                                                ...
                                                                <?php }else{?>
                                                                    <div>Bạn cần nâng cấp gói để có thể xem tin này</div>
                                                            
                                                                    <div><a href="/quan-ly-tai-khoan/nang-cap-tai-khoan/" class="mainbg btn__login c-btn" title="Đăng nhập">Nập cấp tài khoản</a></div>
