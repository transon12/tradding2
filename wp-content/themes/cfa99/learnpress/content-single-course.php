...
<section class="section p-0 snt-single">
    <div class="section-content relative">
        <div class="row row-collapse row-full-width">
            <div class="col medium-12 small-12 large-3 snt-sidebar">
                <div class="col-inner">
                <?php echo do_shortcode('[ux_sidebar id="menu-sidebar" class="menu__sidebar"]');?>
                </div>
            </div>
            <div class="col medium-12 small-12 large-9 snt-main-content">
                <div class="snt-auto" id="learn-press-course">
                    <div class="col-inner snt-single-post">
							<div class="section-content relative">
								<div class="row nobottom">
									<div class="col medium-12 small-12 large-8 snt-article">
										<div class="col-inner">
    ...
    <div class="login-to-learn">
                                                        ...
                                                        <div class="haveto-upgrade haveto__login">
                                                            ...
                                                            <div class="blur-bg-content">
                                                                ...
                                                                <div>Hãy nâng cấp để có thể sử dụng các tính năng đầy đủ và nhận nhiều ưu đãi hấp dẫn</div>
                                                               
                                                                <?php if(($now>$time) && !in_array($id,$permission)){
                                                                    ?>
...
<div><a href="/dang-ky" class="btn__reg c-btn" title="Đăng ký">Đăng ký</a><a href="/dang-nhap" class="mainbg btn__login c-btn" title="Đăng nhập">Đăng nhập</a></div>
                                                        </div>                                                                                                                                <?php } ?>
                                                        </div>
                                                    </div>
                                                    </div>
									...
									<div class="col medium-12 small-12 large-4 snt-rightbar">
										<div class="col-inner">
