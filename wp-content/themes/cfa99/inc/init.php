...
function add_loader_ajax() {
	...
	?>
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri()?>.'/assets/css/tradding.css'">
	<!-- // class="section bg-white pt-1 mobile-sidebar no-scrollbar mfp-hide" id="sidebar-chart" -->
		<div id="" class="mobile-sidebar no-scrollbar mfp-hide">
		<!-- <div class="row row-collapse">
		<div class="col medium-3 small-5 large-3 ">

		</div> -->
		<!-- <div class="col medium-9 small-7 large-9 ">
			<div class="title-box-chart">
				Cổ phiếu xu hướng tăng
			</div>
		</div> -->
		<!-- </div> -->
		<!-- <iframe src="https://info.sbsi.vn/chart/?symbol=VNINDEX&language=vi&theme=light" frameborder="0" width="100%" style="margin:0; height:100vh"></iframe> -->
		</div>

		</div>

<section class=" bg-white pt-1 mobile-sidebar no-scrollbar mfp-hide" id="sidebar-chart" style="background-color:#f4f6f9; height: 100vh">
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri()?>.'/assets/css/tradding.css'">
<div class="isPC ">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xl-8 col-sm-12 col-xs-12 trading-chart iframe-chart">
				<div class="custom-listStock">
			...
			<div class="col-lg-12 col-xl-4 col-sm-12 col-xs-12 pl-1 pt-3 notIndexStock">
			...
			<div class="col-xl-4 col-lg-12 col-sm-12 col-xs-12 pl-1 pt-3 index__stock" style="display:none;">
...
function wpbootstrap_enqueue_styles() {
	...
	wp_enqueue_style( 'select_css', 'https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.15.2/css/selectize.default.min.css' );
	wp_enqueue_style( 'tranding_css',get_stylesheet_directory_uri().'/assets/css/tradding.css' );
	wp_enqueue_script('bootstrap_script', 'https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js', array('jquery'));
	wp_enqueue_script('canvan_script', 'https://cdn.canvasjs.com/jquery.canvasjs.min.js', array('jquery'));
	wp_enqueue_script('select2_script', 'https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.15.2/js/selectize.min.js', array('jquery'));
	wp_enqueue_script('trading_script',get_stylesheet_directory_uri()."/assets/tradding.js", array('jquery'));
