...
?>
	...
	<script src="<?php echo get_stylesheet_directory_uri() ?>/assets/tradding.js"></script>
	<?php
}
	...
	?>
		<div class="popUp" id="popUp-notifi">
			...
			<ul>
				...
				?>
					<li><span><?php echo date('d-m-Y H:i:s', strtotime($key->date_notice)); ?></span>
						<p><?php echo $key->content_notice; ?></p>
					</li>
				<?php } ?>
			</ul>
		</div>
