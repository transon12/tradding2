		...
		<div class="slicewp-card">
			...
			<div class="slicewp-card-inner">
				...
				<div class="slicewp-field-wrapper slicewp-field-wrapper-inline slicewp-tooltip-wide slicewp-last" style="display: none; margin-top: 10px;">
					...
					<select id="slicewp-payout-selected-affiliates" name="selected_affiliates[]" class="slicewp-select2-users-autocomplete" data-affiliates="include" data-return-value="affiliate_id" multiple placeholder="<?php echo __( 'Search for an affiliate...', 'slicewp' ); ?>">
