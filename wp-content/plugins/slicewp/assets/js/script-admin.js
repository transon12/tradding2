            ...
            $this.select2({
                ...
                ajax : {
                    ...
                    data     : function( params ) {
                        ...
                        var query = {
                            term          : params.term,
                            affiliates    : $(this).data('affiliates'),
                            return_value  : ( typeof $(this).data('return-value') != 'undefined' ? $(this).data('return-value') : '' ),
                            slicewp_token : ( typeof $this.attr( 'nonce' ) != 'undefined' ? $this.attr( 'nonce' ) : $('#slicewp_user_search_token').val() )
                        };
