...
Class SliceWP {
	...
	public function enqueue_front_end_scripts() {
		...
		if ( slicewp_get_setting( 'beta_js_file' ) == 'vanilla' )
			wp_register_script( 'slicewp-script', SLICEWP_PLUGIN_DIR_URL . 'assets/js/script-front-end-vanilla.js', array(), SLICEWP_VERSION, true );
		else
